...
public class ProductOfLengthOfNonOverlappingPalindrome {
...
public static void main(String[] args) {
	ProductOfLengthOfNonOverlappingPalindrome l = new ProductOfLengthOfNonOverlappingPalindrome(); 
        System.out.println(l.funPal("axbawbaseksqke"));
